...
class HRLexer(Lexer):
    ...
    def __init__(self, env=None):
        ...
        hr_rules = [
            ...
            Rule(r"(div)", InfixOpAdapter(self.mgr.FloorDiv, 80), False),# floordiv
            ...
            Rule(r"(to_real)", UnaryOpAdapter(self.mgr.ToReal, 100), False),#
            Rule(r"(abs)", UnaryOpAdapter(self.mgr.Abs, 100), False),#
            Rule(r"(to_int)", UnaryOpAdapter(self.mgr.RealToInt, 100), False),#
            ...
            Rule(r"(str\.replace_all)", FunctionCallAdapter(self.mgr.StrReplaceAll, 100), False), # str_replace
            ...
            Rule(r"(str\.to_int)", FunctionCallAdapter(self.mgr.StrToInt, 100), False), # str.to_int
            Rule(r"(str\.from_int)", FunctionCallAdapter(self.mgr.IntToStr, 100), False), # str.from_int
            Rule(r"(str\.to\.int)", FunctionCallAdapter(self.mgr.StrToInt, 100), False), # str.to_int
            Rule(r"(int\.to\.str)", FunctionCallAdapter(self.mgr.IntToStr, 100), False), # str.from_int
            Rule(r"(bv2nat)", UnaryOpAdapter(self.mgr.BVToNatural, 100), False),#
            Rule(r"(str\.to_re)", FunctionCallAdapter(self.mgr.StrToRe, 100), False),
            Rule(r"(str\.in_re)", FunctionCallAdapter(self.mgr.StrInRe, 100), False),
            Rule(r"(str\.to\.re)", FunctionCallAdapter(self.mgr.StrToRe, 100), False),
            Rule(r"(str\.in\.re)", FunctionCallAdapter(self.mgr.StrInRe, 100), False),
            Rule(r"(str\.replace_re)", FunctionCallAdapter(self.mgr.StrReplaceRe, 100), False),
            Rule(r"(str\.replace_re_all)", FunctionCallAdapter(self.mgr.StrReplaceReAll, 100), False),
            Rule(r"(str\.<=)", FunctionCallAdapter(self.mgr.StrCompare, 100), False),
            Rule(r"(re\.\+\+)", FunctionCallAdapter(self.mgr.ReConcat, 100), False),
            Rule(r"(re\.union)", FunctionCallAdapter(self.mgr.ReUnion, 100), False),
            Rule(r"(re\.inter)", FunctionCallAdapter(self.mgr.ReInter, 100), False),
            Rule(r"(re\.\*)", FunctionCallAdapter(self.mgr.ReStar, 100), False),
            Rule(r"(re\.none)", Constant(self.mgr.ReNone()), False),
            Rule(r"(re\.all)", Constant(self.mgr.ReAll()), False),
            Rule(r"(re\.allchar)", Constant(self.mgr.ReAllChar()), False),
            Rule(r"(re\.comp)", FunctionCallAdapter(self.mgr.ReComp, 100), False),
            Rule(r"(re\.diff)", FunctionCallAdapter(self.mgr.ReDiff, 100), False),
            Rule(r"(re\.\+)", FunctionCallAdapter(self.mgr.RePlus, 100), False),
            Rule(r"(re\.opt)", FunctionCallAdapter(self.mgr.ReOpt, 100), False),
            Rule(r"(re\.range)", FunctionCallAdapter(self.mgr.ReRange, 100), False),
            Rule(r"(re\.\^)", FunctionCallAdapter(self.mgr.RePower, 100), False),
            Rule(r"(re\.loop)", FunctionCallAdapter(self.mgr.ReLoop, 100), False),
            Rule(r"(RNE)", Constant(self.mgr.RNE()), False),
            Rule(r"(RNA)", Constant(self.mgr.RNA()), False),
            Rule(r"(RTP)", Constant(self.mgr.RTP()), False),
            Rule(r"(RTN)", Constant(self.mgr.RTN()), False),
            Rule(r"(RTZ)", Constant(self.mgr.RTZ()), False),
