    ...
    with environment:
        ...
        result = [
            ...
            Example(hr="(((p + q) = 5) & (q < p))",
                    expr=And(Equals(Plus(p,q),Int(5)) , LT(q, p)),
                    is_valid=False,
                    is_sat=True,
            ...
            Example(hr="(p < (p - (5 - 2)))",
                    expr=LT(p, Minus(p, Minus(Int(5), Int(2)))),
                    is_valid=False,
                    is_sat=False,
                    logic=pysmt.logics.QF_IDL
                ),
            ...
            Example(hr="(((r + s) = 28/5) & (s < r))",
                    expr=And(Equals(Plus(r,s), Real(Fraction("5.6"))) , LT(s, r)),
                    is_valid=False,
                    is_sat=True,
            ...
            Example(hr="((s <= r) | (r <= s))",
                    expr=Or(LE(s, r), LE(r, s)),
                    is_valid=True,
                    is_sat=True,
                    logic=pysmt.logics.QF_RDL
                ),

            Example(hr="(! ((r / 1/2) < (s * 2.0)))",
            ...
            Example(hr="(! (r < (r - (5.0 - 2.0))))",
                    expr=Not(LT(r, Minus(r, Minus(Real(5), Real(2))))),
                    is_valid=True,
                    is_sat=True,
                    logic=pysmt.logics.QF_RDL
                ),
            ...
            Example(hr="((0_32 u< (5_32 u% 2_32)) & ((5_32 u% 2_32) u<= 1_32))",
                    expr=And(BVULT(BVZero(32), BVURem(BV(5, width=32), BV(2, width=32))),
            ...
            Example(hr="(forall r, s . (((0.0 < r) & (0.0 < s)) -> ((r - s) < r)))",
                    expr=ForAll([r,s],
                                Implies(And(LT(Real(0), r), LT(Real(0), s)),
                                        (LT(Minus(r,s), r)))),
                    is_valid=True,
                    is_sat=True,
            ...
            Example(hr="(exists r . (forall s . (r < (r - s))))",
                    expr=Exists([r], ForAll([s], LT(r, Minus(r,s)))),
                    is_valid=False,
                    is_sat=False,
                    logic=pysmt.logics.LRA
                ),
            ...
            Example(hr="(forall r . (exists s . (r < (r - s))))",
                    expr=ForAll([r], Exists([s], LT(r, Minus(r,s)))),
                    is_valid=True,
                    is_sat=True,
                    logic=pysmt.logics.LRA
                ),
            ...
            Example(hr="(exists x . ((x <-> (5.0 < s)) & (s < 3.0)))",
                    expr=Exists([x], (And(Iff(x, LT(Real(5), s)),
                                          LT(s, Real(3))))),
                    is_valid=False,
                    is_sat=True,
                    logic=pysmt.logics.LRA
            ...
            Example(hr="((p < ih(r, q)) & (x -> y))",
                    expr=And(LT(p, Function(ih, (r, q))), Implies(x, y)),
                    is_valid=False,
                    is_sat=True,
            ...
            Example(hr="(((p - 3) = q) -> ((p < ih(r, (q + 3))) | (ih(r, p) <= p)))",
                    expr=Implies(Equals(Minus(p, Int(3)), q),
                                 Or(LT(p, Function(ih, (r, Plus(q, Int(3))))),
            ...
            Example(hr="(((to_real((p - 3)) = r) & (to_real(q) = r)) -> ((p < ih(to_real((p - 3)), (q + 3))) | (ih(r, p) <= p)))",
                    expr=Implies(And(Equals(ToReal(Minus(p, Int(3))), r),
                                     Equals(ToReal(q), r)),
                                 Or(LT(p, Function(ih, (ToReal(Minus(p, Int(3))),
                                                     Plus(q, Int(3))))),
                                    LE(Function(ih, (r, p)), p))),
                    is_valid=True,
                    is_sat=True,
            ...
            Example(hr='(str.from_int(9) = "9")',
                    expr=Equals(IntToStr(Int(9)), String("9")),
                    is_valid=True,
                    is_sat=True,
                    logic=pysmt.logics.QF_SLIA),

            Example(hr='(str.to_int("9") = 9)',
                    expr=Equals(StrToInt(String("9")), Int(9)),
                    is_valid=True,
                    is_sat=True,
                    logic=pysmt.logics.QF_SLIA),

            ## Disabled as ambiguous identifiers, such as 10, are now quoted by default in the HR representation
