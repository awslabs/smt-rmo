...
class TestLogic(TestCase):
    ...
    def test_get_logics_min(self):
        tests = [
            ...
            (pysmt.logics.QF_SLIA, get_logic(quantifier_free=True,
                                              uninterpreted=True,
                                              integer_arithmetic=True,
                                              strings=True)),
            (pysmt.logics.QF_BVRE, get_logic(quantifier_free=True,
                                              bit_vectors=True,
                                              strings=True,
                                              regexes=True)),
            (pysmt.logics.QF_AUFBVLIRA, get_logic(quantifier_free=True,
                                              bit_vectors=True,
                                              linear=True,
                                              uninterpreted=True,
                                              arrays=True,
