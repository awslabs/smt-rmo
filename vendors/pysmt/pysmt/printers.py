...
class HRPrinter(TreeWalker):
    ...
    def walk_real_constant(self, formula):
        if isinstance(formula.constant_value(), float) or isinstance(formula.constant_value(), int):
            res = str(formula.constant_value())
            if not "." in res:
                res += ".0"
            self.write(res)
        else:
    ...
    def walk_let(self, formula):
        if len(formula.let_defs()) > 0:
            self.write("(let ")
            for s in formula.let_defs()[:-1]:
                yield s[0]
                self.write(" is ")
                yield s[1]
                self.write(", ")
            yield formula.let_defs()[-1][0]
            self.write(" is ")
            yield formula.let_defs()[-1][1]
            self.write(" in ")
            yield formula.arg(0)
            self.write (")")
        else:
    ...
    def walk_str_to_re(self, formula):
        self.write("str.to_re(")
        yield formula.arg(0)
        self.write(")")

    def walk_str_in_re(self, formula):
    ...
    def walk_re_all(self, formula):
        self.write("re.all")
    
    def walk_re_allchar(self, formula):
        self.write("re.allchar")

    def walk_re_none(self, formula):
        self.write("re.none")
    
    def walk_re_concat(self, formula):
        self.write("re.++(")
        yield formula.arg(0)
        self.write(", ")
        yield formula.arg(1)
    ...
    def walk_re_inter(self, formula):
        self.write("re.inter(")
        yield formula.arg(0)
        self.write(", ")
        yield formula.arg(1)
    ...
    def walk_re_union(self, formula):
        self.write("re.union(")
        yield formula.arg(0)
        self.write(", ")
        yield formula.arg(1)
    ...
    def walk_re_star(self, formula):
        self.write("re.*(")
        yield formula.arg(0)
        self.write(")")

    def walk_re_comp(self, formula):
        self.write("re.comp(")
        yield formula.arg(0)
        self.write(")")

    def walk_re_diff(self, formula):
        self.write("re.*(")
        yield formula.arg(0)
        self.write(", ")
        yield formula.arg(1)
    ...
    def walk_re_plus(self, formula):
        self.write("re.+(")
        yield formula.arg(0)
        self.write(")")

    def walk_re_opt(self, formula):
        self.write("re.opt(")
        yield formula.arg(0)
        self.write(")")

    def walk_re_range(self, formula):
        self.write("re.range(")
        yield formula.arg(0)
        self.write(", ")
        yield formula.arg(1)
    ...
    def walk_re_power(self, formula):
    ...
    def walk_re_loop(self, formula):
        lb, ub = formula.re_loop_bounds()
        self.write(f"((_ re.loop {lb} {ub}) ")
        yield formula.arg(0)
        self.write(")")

    def walk_rne(self, formula):
        self.write("RNE")
    
    def walk_rna(self, formula):
        self.write("RNA")
    
    def walk_rtp(self, formula):
        self.write("RTP")
    
    def walk_rtn(self, formula):
        self.write("RTN")

    def walk_rtz(self, formula):
        self.write("RTZ")
    ...
    def walk_floor_div(self, formula): return self.walk_nary(formula, " // ")
    ...
    def walk_ge(self, formula): return self.walk_nary(formula, " >= ")
    def walk_gt(self, formula): return self.walk_nary(formula, " > ")
    def walk_bv_xor(self, formula): return self.walk_nary(formula, " xor ")
    def walk_bv_xnor(self, formula): return self.walk_nary(formula, " xnor ")
    ...
    def walk_bv_smod(self, formula): return self.walk_nary(formula, " smod ")
    ...
    def walk_bv_uge(self, formula): return self.walk_nary(formula, " u>= ")
    def walk_bv_ult(self, formula): return self.walk_nary(formula, " u< ")
    def walk_bv_ugt(self, formula): return self.walk_nary(formula, " u> ")
